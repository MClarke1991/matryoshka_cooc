...
def main() -> None:
    ...
    # Configuration
    input_dir = "cooc_n_batches_50_layer_8"  # Directory containing co-occurrence matrices
    output_dir = "graph_cooc_n_batches_50_layer_8"  # Directory for output
    activation_thresholds = [10.0]  # Thresholds to process
